...
import com.example.mybottomnavbar.databinding.FragmentTypeBinding
...
class TypeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        with(binding){
            val ticketType = resources.getStringArray(R.array.jenis_tiket)
            ...
            spinnerTiketType.adapter = adapterType

            btnChooseTicketType.setOnClickListener {
                findNavController().apply {
                    previousBackStackEntry?.savedStateHandle?.set("type", spinnerTiketType.selectedItem.toString())
                }.navigateUp()
            }
        }
